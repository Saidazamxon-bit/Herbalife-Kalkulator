...
type SortType = 'default' | 'name' | 'vp' | 'price';
...
function HomeContent() {
  ...
  // 🔍 useMemo bilan filtrlash va saralash
    ...
    return allProducts
      ...
      .sort((a, b) => {
        switch (sortType) {
          ...
          case 'default':
          default:
            return 0; // Asl ketma-ketlikni saqlab qolish
        }
      });
  }, [allProducts, searchQuery, sortType, discount]);
      ...
      <section className="py-4 px-3 sm:px-4 bg-white dark:bg-slate-900 border-b border-green-100 dark:border-green-900 sticky top-16 z-30">
        <div className="mx-auto max-w-7xl space-y-3">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            {(['default', 'name', 'vp', 'price'] as const).map((sort) => (
              <button
                key={sort}
