...
export function CartSummary({
  ...
  if (isFloating) {
    return (
      <div className="fixed top-24 right-4 z-30 bg-white dark:bg-slate-900 rounded-xl shadow-xl border-2 border-green-200 dark:border-green-900 p-4 max-w-xs hidden lg:block">
